...
public class Oval extends Shape
{
    ...
    {
        super(color, filled);
        location = new Point[] {pointCenter};
    ...
    public void draw(Graphics graphics)
    {
        ...
        if(super.isFilled())
        {
            graphics.fillOval((int)p[0].getX(), (int)p[0].getY(), diameter1, diameter2);
        }
        else
        {
        graphics.drawOval((int)p[0].getX(), (int)p[0].getY(), diameter1, diameter2);
        }
