...
public class RightTriangle extends Polygon
{
    ...
    public RightTriangle(Point pointRightAngle, int base, int height, Color color, boolean filled)
    {
        ...
        Point pointBV = new Point((int)pointRightAngle.getX()+base, (int)pointRightAngle.getY());
        Point pointHV = new Point((int)pointRightAngle.getX(), (int)pointRightAngle.getY()+height);
        
        location = new Point[] {pointRightAngle, pointBV, pointHV};
    }
}
